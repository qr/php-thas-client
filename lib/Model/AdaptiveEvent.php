...
/**
 * AdaptiveEvent Class Doc Comment
 *
 * @category Class
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdaptiveEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdaptiveEvent';
    ...
    const ACTION_FORCE_COMPLETION = 'ForceCompletion';
     ...
     * Sets track
     *
     * @param string|null $track the track that needs force completion
     *
     * @return $this
     */
