...
/**
 * AcrosticPuzzleAnswer Class Doc Comment
 *
 * @category Class
 * @description Acrostic puzzle answer type
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AcrosticPuzzleAnswer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcrosticPuzzleAnswer';
     ...
     * Sets solution
     *
     * @param string|null $solution The solution to the puzzle based on the user input
     *
     * @return $this
     */
     ...
     * Sets words
     *
     * @param string[]|null $words The words the user entered into the puzzle (top-down)
     *
     * @return $this
     */
