 ...
 *
 * @category Class
 * @description external tools that are integrated in or linked from the application or the content should be logged by this event. This is a special navigation event since it is used register tool usage
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
