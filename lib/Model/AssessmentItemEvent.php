...
/**
 * AssessmentItemEvent Class Doc Comment
 *
 * @category Class
 * @description The assessmentitem registers the answers of a student to a question. We need to further refine this for all interaction types
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AssessmentItemEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssessmentItemEvent';
     ...
     * Sets target
     *
     * @param string $target Assignment within the object the answer belongs to. This must be the contentidentifier that matches the standard.
     *
     * @return $this
     */
