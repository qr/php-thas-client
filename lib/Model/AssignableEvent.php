...
/**
 * AssignableEvent Class Doc Comment
 *
 * @category Class
 * @description An assignable event registers the usage of an assignment, indpendend of the answer and the grade. We need to discuss if this is neccessary or too much overhead!!!
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AssignableEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssignableEvent';
     ...
     * Sets target
     *
     * @param string $target Assignment within the stream that is made. This must be the contentidentifier that matches the standard.
     *
     * @return $this
     */
