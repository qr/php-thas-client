...
/**
 * NavigationEvent Class Doc Comment
 *
 * @category Class
 * @description The navigation event registers each relevant click in the application. The target url of the navigation is required, if available also register the referer url.
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NavigationEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NavigationEvent';
    ...
    const ACTION_NAVIGATED_TO = 'NavigatedTo';
     ...
     * Sets object
     *
     * @param string|null $object the content identifier of the digital resource this event relates to. This is the stream identifier.
     *
     * @return $this
     */
     ...
     * Sets target
     *
     * @param string $target Url of the page that is navigated to
     *
     * @return $this
     */
     ...
     * Sets referer
     *
     * @param string|null $referer Url of the page that is navigated from
     *
     * @return $this
     */
     ...
     * Sets session
     *
     * @param string|null $session The id of the session this event belongs to
     *
     * @return $this
     */
