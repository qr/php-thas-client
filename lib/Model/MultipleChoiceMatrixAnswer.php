...
/**
 * MultipleChoiceMatrixAnswer Class Doc Comment
 *
 * @category Class
 * @description Multiple choice matrix answer type
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MultipleChoiceMatrixAnswer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultipleChoiceMatrixAnswer';
     ...
     * Sets matches
     *
     * @param \Thas\Model\Match[]|null $matches matches
     *
     * @return $this
     */
