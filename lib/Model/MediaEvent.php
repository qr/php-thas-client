...
/**
 * MediaEvent Class Doc Comment
 *
 * @category Class
 * @description media events register special actions on media like starting, pausing and stopping audio and video and enlarging images
 * @package  Thas
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MediaEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaEvent';
    ...
    const ACTION_ENLARGED = 'Enlarged';
     ...
     * Sets target
     *
     * @param string $target url of the media being used
     *
     * @return $this
     */
