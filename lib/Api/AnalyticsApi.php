...
class AnalyticsApi
{
    ...
    /**
     * Operation learningAnalyticsPost
     *
     ...
     * @return void
     */
    public function learningAnalyticsPost($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event = null)
    {
        $this->learningAnalyticsPostWithHttpInfo($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event);
    }

    /**
     * Operation learningAnalyticsPostWithHttpInfo
     *
     ...
     */
    public function learningAnalyticsPostWithHttpInfo($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event = null)
    {
        $request = $this->learningAnalyticsPostRequest($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event);
    ...
    /**
     * Operation learningAnalyticsPostAsync
     *
     * 
     *
     * @param  OneOfViewEventGradeEventAssignableEventSessionEventNavigationEventToolUseEventMediaEventAssesmentItemEvent[] $one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event (optional)
     ...
     */
    public function learningAnalyticsPostAsync($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event = null)
    {
        return $this->learningAnalyticsPostAsyncWithHttpInfo($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation learningAnalyticsPostAsyncWithHttpInfo
     *
     * 
     *
     * @param  OneOfViewEventGradeEventAssignableEventSessionEventNavigationEventToolUseEventMediaEventAssesmentItemEvent[] $one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function learningAnalyticsPostAsyncWithHttpInfo($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event = null)
    {
        $returnType = '';
        $request = $this->learningAnalyticsPostRequest($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event);
    ...
    /**
     * Create request for operation 'learningAnalyticsPost'
     *
     * @param  OneOfViewEventGradeEventAssignableEventSessionEventNavigationEventToolUseEventMediaEventAssesmentItemEvent[] $one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function learningAnalyticsPostRequest($one_of_view_event_grade_event_assignable_event_session_event_navigation_event_tool_use_event_media_event_assesment_item_event = null)
    {
